  ...
  genWorks = () => {
    ...
    const tips = [
      ...
      genWork(
        ...
        ["CG"],
        "スマホの重力センサと全天球画像を使ってVRっぽいことをするアプリ。背景に板ポリを置いていて、スマホの重力センサから視線ベクトルを計算してテクスチャマッピングしている。もともとは文系講義で「ファンタジーな道具をプレゼンする」みたいな作品課題が出された時、初めてのwebGLで作れるギリギリの技術力の中で「ワープゲート」を悪戦苦闘しながら表現したもの。浮かんでいるキューブをタップするとシーンが遷移する",
        "2018/06"
      ),
      genWork(
        "Tips",
